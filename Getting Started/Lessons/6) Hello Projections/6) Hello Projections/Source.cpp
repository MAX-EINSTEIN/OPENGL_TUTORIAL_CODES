...
int main()
{
	...
	Texture texture2("splash.jpg", GL_TEXTURE1);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// setting up the model, view and projection matrix 
		ourShader.use();
		...
		for (unsigned int i = 0; i < 10; i++)
		{
			...
			if ((i % 3) == 0)
				...
				model = glm::rotate(model, (float)glm::sin(glfwGetTime()), glm::vec3(1.0f, 0.3f, 0.5f));
